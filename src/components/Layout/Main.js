            ...
            <div className="font-medium text-gray-700 lg:mr-60 w-full flex flex-col justify-center items-center">
                ...
                <div className="flex lg:mb-0 mb-4">
                    ...
                    <a target="_blank" rel="noreferrer" href="https://linkedin.com/in/paul-yeboah-asamoah-7580ab1b4">
                        <FontAwesomeIcon 
                            icon={faLinkedinIn} 
                            className="p-2 transition ease-in-out delay-120 hover:-translate-y-1 duration-300 border mx-2 active:bg-gray-200 cursor-pointer rounded-xl" 
                    ...
                    <a target="_blank" rel="noreferrer" href="https://github.com/paulyeb">
                        <FontAwesomeIcon 
                            icon={faGithub} 
                            className="p-2 border transition ease-in-out delay-120 hover:-translate-y-1 duration-300 mx-2 active:bg-gray-200 cursor-pointer rounded-lg" 
                            style={{  width: '25px', height: '25px'}} 
                        /> 
                    </a>
                    <a target="_blank" rel="noreferrer" href="https://twitter.com/manlikeluda">
                        <FontAwesomeIcon 
                            icon={faTwitter} 
                            className="p-2 border transition ease-in-out delay-120 hover:-translate-y-1 duration-300 mx-2 active:bg-gray-200 cursor-pointer rounded-xl" 
                            style={{ width: '25px', height: '25px'}} 
                        />
                    </a>
