export default () => {
    const projects = [
        ...
        {
            id: 2,
            title: "Lekem's Organics",
            image: "/lekem's organics.jpg",
            description: "Drafted web application for skincare business owner. This is not the final work, client is not ready with the content of the app, this is only a layout as I wait for client to supply neccessary pictures and information.",
            skills: " This system was built with Tailwindcss, React.js, making use of React Hooks & Custom Hooks, React Context API.",
            github: "https://github.com/paulyeb/lekem's organics",
            site: "https://lekemsorganics.herokuapp.com/",
            live_demo: "",
            theme: "Business Website"
        },
        {
            id: 3,
